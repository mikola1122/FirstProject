...
public class SharedPrefConstants {
    public static final String KEY_KEYBORD_BACKGROUND_COLOR = "BackgroundColor";
    public static final String KEY_KEYBORD_BACKGROUND_TRANSPARENCY = "BackgroundTransparency";
    public static final String KEY_KEYBORD_SIZE_MODE = "KeyboardSizeMode";
    public static final String KEY_KEYBORD_SIZE = "KeyboardSize";
    public static final String KEY_KEYBORD_FONT_SIZE = "KeyboardFontSize";
